...
// Onglets : Paramètres | Météo | Aéroports
      ...
      <Section title="Images & Branding">
        <div className={styles.fieldRow}>
          ...
          <div className={styles.field}>
            ...
            <div className={styles.uploadZone} onClick={() => document.getElementById(`bg-input-${hotelId}`).click()}>
            ...
            <input id={`bg-input-${hotelId}`} type="file" accept="image/*" style={{ display: 'none' }}
